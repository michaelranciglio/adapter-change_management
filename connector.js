...
class ServiceNowConnector {
   ...
   * @memberof ServiceNowConnector
   * @method constructUri
   * @summary Constructs uri based on optiosn passed in
   ...
   * @summary Checks if the instance is hibernating
   ...
   * @summary generic function to handle request errors and results
   ...
   * @memberof ServiceNowConnector
   * @method sendRequest
   * @summary sends a request based on the contents of callOptions
